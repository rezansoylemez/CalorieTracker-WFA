...
namespace SaglikliYER
{
    ...
    private void btnBack_Click(object sender, EventArgs e)
        ...
        private void FormBilgilendirme_Load(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    lblBilgilendirme.Text = "SocialFit ? SocialFit is a free diet application that helps you to " +
                ...
                case 1:
                    lblBilgilendirme.Text = "SocialFit team is composed of three people." +
                    "Talented software developers who come together to create this project are; \nRezan Söylemez, " +
                    "\nYunus Emre Çakal (Esra's love <3), \nEmre Özpınar"; break;
                case 2:
                    lblBilgilendirme.Text = "The Karatay diet, which can also be defined as the 'Canan Karatay' " +
                ...
                case 3:
                    lblBilgilendirme.Text = "The ketogenic diet is a low-carbohydrate diet in which high-fat foods " +
                ...
                case 4:
                    lblBilgilendirme.Text = "SocialFit@info.com you can contact us 24/7 via email adress." +
